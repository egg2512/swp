...
;
const metadata = {
    title: 'Bí Đao Thiên Nhiên Việt Nam: Nguồn Cội Thanh Lọc Dịu Mát Của Cocoon',
    description: 'Khám phá bí mật đằng sau làn da thanh khiết từ Nước Tẩy Trang Bí Đao Cocoon – nơi mỗi giọt tinh túy chắt lọc từ thiên nhiên Việt Nam.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
